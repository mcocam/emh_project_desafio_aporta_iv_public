...
import { descSetChapters } from "../../../../../redux/slices/descriptiveSlices/descriptiveSlice";
...
export const DxChapterSelector = () => {
    ...
    const selectedChapters = useSelector( (state) => state.descriptive.chapters );

    const handleChange = (event) => {
        dispatch(descSetChapters(event));
    }
    ...
    useEffect( () => {
        if (dxList){
            ...
            dispatch(descSetChapters(uniqueChapters));
        }
