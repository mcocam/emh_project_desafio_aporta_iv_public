...
import { kpiSetSelectedYear } from '../../../../../redux/slices/kpiSlice/kpiSlice';
...
export const YearSelector = () => {
    ...
    const selectedYear = useSelector( (state) => state.kpi.year );

    const handleSelection = (event) => {
        dispatch( kpiSetSelectedYear(event.target.value) );
    }

    useEffect( () => {
        dispatch( kpiSetSelectedYear(maxYear) );
    }, [maxYear])
