...
export const TopExitusTable = ({data}) => {
                ...
                <Table aria-label="Top 10 CCSR Average Stay" size="small">
                    ...
                    {data.map((d) => (
                        ...
                        >
                            ...
                            <TableCell align="center" size="small" sx={{fontSize: '0.7rem'}}>{prettifyNumber(roundTo(+d.observed, 0))}</TableCell>
                            <TableCell align="center" size="small" sx={{fontSize: '0.7rem'}}>{prettifyNumber(roundTo(+d.expected, 2))}</TableCell>
